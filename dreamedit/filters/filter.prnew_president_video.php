...
if ($_SESSION[lang]!='/en')
{
    for ($i=0; $i < $count_vg; $i++) {
        ...
        if(!empty($arr_video_sidebar_dynkin[$i]['time_seconds'])) $params .= "&start=".$arr_video_sidebar_dynkin[$i]['time_seconds']. "&t=" . $arr_video_sidebar_dynkin[$i]['time_seconds'];
        $par="1";
                                ...
                                <div class="col-12">
                                    <div class="img-block position-relative">
                                        ...
                                        <div class="video-iframe-button-div">
                                            <button class="btn btn-secondary" type="button" onclick="javascript:doPopup('<?php if(substr($arr_video_sidebar_dynkin[$i]['youtube_url'],0,5)=="http:") {echo "http://"; $arr_video_sidebar_dynkin[$i]['youtube_url']=str_replace("http://","",$arr_video_sidebar_dynkin[$i]['youtube_url']);} else echo "//";?><?=$arr_video_sidebar_dynkin[$i]['youtube_url'].$params?>', <?=$par?>)"><i class="fas fa-video"></i> Смотреть</button>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="img-block position-relative">
                            ...
                            <div class="video-iframe-button-div">
                                <button class="btn btn-secondary video-gallery-button-small" type="button" onclick="javascript:doPopup('<?php if(substr($arr_video_sidebar_dynkin[$i]['youtube_url'],0,5)=="http:") {echo "http://"; $arr_video_sidebar_dynkin[$i]['youtube_url']=str_replace("http://","",$arr_video_sidebar_dynkin[$i]['youtube_url']);} else echo "//";?><?=$arr_video_sidebar_dynkin[$i]['youtube_url'].$params?>', <?=$par?>)"><i class="fas fa-video"></i> Смотреть</button>
                            </div>
                        </div>
                        <?php if (!empty($arr_video_sidebar_dynkin[$i]['url'])): ?>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="img-block position-relative">
                                        <img src="<?=$arr_video_sidebar_dynkin[$i]['photo_stop']?>" alt="" class="w-100 box-img-100">
                                        <div class="video-iframe-button-div">
                                            <button class="btn btn-secondary" type="button" onclick="javascript:doPopup('<?php if(substr($arr_video_sidebar_dynkin[$i]['youtube_url'],0,5)=="http:") {echo "http://"; $arr_video_sidebar_dynkin[$i]['youtube_url']=str_replace("http://","",$arr_video_sidebar_dynkin[$i]['youtube_url']);} else echo "//";?><?=$arr_video_sidebar_dynkin[$i]['youtube_url'].$params?>', <?=$par?>)"><i class="fas fa-video"></i> Watch</button>
                                        </div>
                                    </div>
                                    <?php if (!empty($arr_video_sidebar_dynkin[$i]['url'])): ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="img-block position-relative">
                            <img src="<?=$arr_video_sidebar_dynkin[$i]['photo_stop']?>" alt="" class="w-100 box-img-30">
                            <div class="video-iframe-button-div">
                                <button class="btn btn-secondary video-gallery-button-small" type="button" onclick="javascript:doPopup('<?php if(substr($arr_video_sidebar_dynkin[$i]['youtube_url'],0,5)=="http:") {echo "http://"; $arr_video_sidebar_dynkin[$i]['youtube_url']=str_replace("http://","",$arr_video_sidebar_dynkin[$i]['youtube_url']);} else echo "//";?><?=$arr_video_sidebar_dynkin[$i]['youtube_url'].$params?>', <?=$par?>)"><i class="fas fa-video"></i> Watch</button>
                            </div>
                        </div>
                        <?php if (!empty($arr_video_sidebar_dynkin[$i]['url'])): ?>
