...
<div class="col-12 pb-3">
    <div class="mx-auto p-3 text-left container-fluid shadow bg-white massmedia-board mb-3 position-relative h-100">
        ...
        <div class="position-absolute overlay-bottom-null overlay-left-null">
            <div class="col-12 my-auto text-center img-height-block">
                <?=$img_smi_piar?>
            </div>
        </div>
        <div class="news-upper-link position-absolute"><a target="_blank" href="/index.php?page_id=502&amp;id=<?=$rows[id]?>"><i class="fas fa-link"></i></a></div>
        <a href="/index.php?page_id=502&amp;id=<?=$rows[id]?>" target="_blank" class="h-100 w-100 position-absolute overlay-top-left-null hover-highlight" draggable="true"></a>
    </div>
</div>
<?php
}