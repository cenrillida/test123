                                            ...
                                            <div class="col-12 my-auto">
                                                <div class="position-relative">
                                                    ...
                                                    <div class="video-iframe-button-div">
                                                        <a href="javascript:doPopup('//<?=$sliderElement["content"]['YOUTUBE_URL'].$params?>', <?=$par?>)" class="btn btn-secondary video-iframe-button-presscenter"><i class="fas fa-video"></i> Смотреть</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
