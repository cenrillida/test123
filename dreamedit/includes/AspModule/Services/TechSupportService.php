...
class TechSupportService {
    ...
    public function sendData($fields) {
        ...
        \MailSend::send_mime_mail("Аспирантура ИМЭМО РАН", "noreply@imemo.ru", "", "alexqw1@yandex.ru,asp_tech_support@imemo.ru", "cp1251", "utf-8", "Запрос технической поддержки", $data);
