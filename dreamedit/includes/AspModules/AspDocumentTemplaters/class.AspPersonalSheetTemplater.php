...
class AspPersonalSheetTemplater extends AspDocumentTemplater {
    ...
    public function __construct()
    {
        ...
        for ($i=1; $i<=12; $i++) {
            ...
            $templateFields["university_name_place".$i] = new DocumentTextField("", 1, 43, 7.5, 9, $coordinate, "university_name_place".$i, "C", 7);
            $templateFields["university_faculty".$i] = new DocumentTextField("", 1, 22, 7.5, 51.5, $coordinate, "university_faculty".$i, "C", 7);
            ...
            $templateFields["university_special_number".$i] = new DocumentTextField("", 1, 45, 7.5, 155.8, $coordinate, "university_special_number".$i, "C", 7);
        }
        ...
        for ($i=1; $i<=34; $i++) {
            ...
            $templateFields["work_position".$counter] = new DocumentTextField("", 1, 84,6.53,67, $coordinate, "", "C", 7);
            $templateFields["work_place".$counter] = new DocumentTextField("", 1, 53,6.53,149.5, $coordinate, "", "C", 7);
        }
