...
class AspLoginFormPageBuilder implements AspPageBuilder {
    ...
    public function build()
    {
        ...
        if($_SESSION[lang]!="/en") {
            $formBuilder = new AspLoginFormBuilder("Успешная авторизация.","","/files/File/graduate_school/","Войти");
        ...
        <div class="container-fluid">
            <div class="row justify-content-end mb-3">
                <div class="ml-3 mt-3">
                    <a class="btn btn-lg imemo-button text-uppercase" href="/index.php?page_id=<?=$this->pages->getFirstPageIdByTemplate("asp_lk_password_reset")?>" role="button">Восстановить пароль</a>
                </div>
                <div class="ml-3 mt-3">
                    <a class="btn btn-lg imemo-button text-uppercase" href="/index.php?page_id=<?=$this->pages->getFirstPageIdByTemplate("asp_lk_register")?>" role="button">Регистрация</a>
                </div>
            </div>
        </div>
