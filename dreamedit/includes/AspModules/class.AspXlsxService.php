...
// Add some data
            ...
            if($fields['field_of_study']=="1") {
                $columns[] = array('title' => Dreamedit::encodeText('Направление подготовки'), 'width' => 50);
            }
            if($fields['field_of_study_profile']=="1") {
                $columns[] = array('title' => Dreamedit::encodeText('Профиль'), 'width' => 80);
            }
            if($fields['gender']=="1") {
...
// Set active sheet index to the first sheet, so Excel opens this as the first sheet
            ...
            $this->aspModule->getAspDownloadService()->echoExcelHeader(Dreamedit::encodeText("Список пользователей личного кабинета аспирантуры.xlsx"));
