...
function setCookie(name, value, expires, path, domain, secure) {
  ...
  document.cookie = curCookie;
   ...
   //         alert(GetE('chEn').checked);
			if (!(GetE('chEn').checked))
				GetE('linkURL').value = "/index.php?page_id=80&id=" + setPageLink;
	        else
				GetE('linkURL').value = "/index.php?page_id=80&id=" + setPageLink+"&en";

			GetE('chkSmallPhoto').value = "http://inion.isras.ru/dreamedit/foto/" + setPicSmall;
			GetE('chkBigPhoto').value = "http://inion.isras.ru/dreamedit/foto/" + setPicBig;
