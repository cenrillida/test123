...
function setCookie(name, value, expires, path, domain, secure) {
  ...
  document.cookie = curCookie;
		...
		function enrus()
		{
		  ...
		  if (a!=null)
		  {
		     var b=document.getElementById('chkEn');
			 var c=a.value;
			
			 if (b.checked==true)
			 {
			    if (c.substr(0,3)!='/en') document.getElementById('linkURL').value="/en"+c;
			 }
		     else
			 {
			   
			   if (c.substr(0,3)=='/en') document.getElementById('linkURL').value=c.substr(3);
			 }
		  }
...
//									print_r($p2podr);
					...
					<tr>
						...
						<td width="100%" style="align:right;"><input id="chkEn"  onChange=enrus() type="checkbox" name="chkEn" value=""></td>
					</tr>
					<tr>
