...
FCKCommands.RegisterCommand( 'FileIcon'		, new FCKDialogCommand( FCKLang['DlgFileIconTitle']	, FCKLang['DlgFileIconTitle']		, FCKConfig.PluginsPath + 'FileIcon/fileicon.html'	, 330, 280 ) ) ;
