...
( function() {
	...
	CKEDITOR.plugins.add( 'indentt', {
		// jscs:disable maximumLineLength
		lang: 'af,ar,az,bg,bn,bs,ca,cs,cy,da,de,de-ch,el,en,en-au,en-ca,en-gb,eo,es,es-mx,et,eu,fa,fi,fo,fr,fr-ca,gl,gu,he,hi,hr,hu,id,is,it,ja,ka,km,ko,ku,lt,lv,mk,mn,ms,nb,nl,no,oc,pl,pt,pt-br,ro,ru,si,sk,sl,sq,sr,sr-latn,sv,th,tr,tt,ug,uk,vi,zh,zh-cn', // %REMOVE_LINE_CORE%
		// jscs:enable maximumLineLength
		icons: 'indentt,indentt-rtl,outdentt,outdentt-rtl', // %REMOVE_LINE_CORE%
		hidpi: true, // %REMOVE_LINE_CORE%

		init: function( editor ) {
			var genericDefinition = CKEDITOR.plugins.indentt.genericDefinition;

			// Register generic commands.
			setupGenericListeners( editor, editor.addCommand( 'indentt', new genericDefinition( true ) ) );
			setupGenericListeners( editor, editor.addCommand( 'outdentt', new genericDefinition() ) );

			// Create and register toolbar button if possible.
			if ( editor.ui.addButton ) {
				editor.ui.addButton( 'Indentt', {
					label: "Увеличить красную строку",
					command: 'indentt',
					directional: true,
					toolbar: 'indent,40'
				} );

				editor.ui.addButton( 'Outdentt', {
					label: "Удалить красную строку",
					command: 'outdentt',
					directional: true,
					toolbar: 'indent,30'
				} );
	...
	CKEDITOR.plugins.indentt = {
		...
		specificDefinition: function( editor, name, isIndent ) {
			 ...
			 * @readonly
			 */
			this.relatedGlobal = isIndent ? 'indentt' : 'outdentt';
	...
	CKEDITOR.plugins.indentt.genericDefinition.prototype = {
		context: 'p',

		exec: function() {}
	};

	CKEDITOR.plugins.indentt.specificDefinition.prototype = {
		/**
