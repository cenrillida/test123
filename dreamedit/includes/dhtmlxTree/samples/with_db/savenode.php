<?php
	...
	if($_POST["item_id"]==-1){
		saveInsert($_POST["item_nm"],$_POST["item_parent_id"],$_POST["item_desc"],$_POST["item_order"]);
	}else{
		saveUpdate($_POST["item_id"],$_POST["item_nm"],$_POST["item_parent_id"],$_POST["item_desc"],$_POST["item_order"]);
	}
	...
	function saveInsert($name,$parent_id,$desc,$order){
		$u_sql = "UPDATE tree SET item_order=item_order+1 WHERE item_parent_id=".$parent_id." AND item_order>".($order-1);
		$res = mysql_query($u_sql);        
