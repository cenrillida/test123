...
function Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='')
{
	...
	function getCurrentWidthFixed($w, $h, $txt, $border=0, $align='J', $fill=false, $lineHeightArray = array())
	{
		...
		while($i<$nb)
		{
			if(!empty($lineHeightArray[$nl])) {
				$h = $lineHeightArray[$nl];
			}
			// Get next character
			if ($this->unifontSubset) {
...
function MultiCell($w, $h, $txt, $border=0, $align='J', $fill=false, $lineHeightArray = array(),$pdf="",$setFont="",$fontStyle="",$fontSize="",$spaceFont="")
{
	// Output text with automatic or explicit line breaks
	if(!isset($this->CurrentFont))
		$this->Error('No font has been set');
...
//			//var_dump($c);
//			if ($c == ' ' && $firstSpace) {
//				$pdf->SetFont($setFont, $fontStyle, $spaceFont);
//				//$cw = &$this->CurrentFont['cw'];
//		} else {
//				$pdf->SetFont($setFont, $fontStyle, $fontSize);
//				//$cw = &$this->CurrentFont['cw'];
//				$firstSpace = false;
//			}
//		}
