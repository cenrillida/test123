...
$mod_array = array(
	...
	"components"	=> array (
		...
		"affiliation" => array(
			...
			"prompt" => Dreamedit::translate("Аффилиация"),
            "cols" => "81",
			"rows"=>"5",
			"field" => "affiliation",
        ...
        "affiliation_en" => array(
			"class" => "base::editor_half",
			"prompt" => Dreamedit::translate("Аффилиация на английском"),
            "cols" => "81",
			"rows"=>"5",
        ...
        "add_text" => array(
            "class" => "base::editor",
            "prompt" => Dreamedit::translate("Финансирование"),
            "field" => "add_text",

        ),
        "add_text_en" => array(
            "class" => "base::editor",
            "prompt" => Dreamedit::translate("Финансирование на английском"),
            "field" => "add_text_en",
