...
$tree->displayTreeBases(Dreamedit::translate("Публикации"),"".$_CONFIG["global"]["paths"]["site"].$_CONFIG["global"]["paths"]["admin_dir"].$_CONFIG["global"]["paths"]["skin_path"]."/images/dTree/",$bases);
