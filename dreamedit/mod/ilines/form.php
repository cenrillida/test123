...
$mod_array = array (
	...
	"components"	=> array (
		...
		"auto_structure"			=> array (
			"class"				=> "base::textarea",
			"prompt"			=> Dreamedit::translate("Структура авто заполнения"),
			"help"				=> Dreamedit::translate("Структура автоматического заполнения данных"),
			"cols"				=> "111",
			"rows"				=> "30",
			"field"				=> "itype_auto_structure",
		),
	),
);
