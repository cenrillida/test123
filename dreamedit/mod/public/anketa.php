...
<font color=red>*</font><b>Название (полная библиографическая ссылка)</b>
<br>
<textarea name=name cols=120 class="publ_search"><? echo $_POST['name']; ?></textarea>
<br>
<b>Название на английском</b>
<br>
...
?>
<br /><br />
<b>Начальная страница: </b><input name='page_beg' id='page_beg'></ipput>
<br /><br />
<table>
<tr>

<td>
<font color=red>*</font><b>Год выпуска</b>
<br>
...
<table><tr>
<td>
<font color=red>*</font><b>Вид</b>
<br>

<?

// Вид и тип публикации берутся из базы
...
<br>
<b>Ключевые слова на английском(разделяются точкой с запятой)</b>
<br>
...
<br>
<input type=checkbox name=vid_inion <? if($_POST['vid_inion'] == '1') echo "checked"; ?>>&nbsp;Не включать в общий список
<br><br>
    Размещено в РИНЦ <input type=edit name=rinc id='rinc'><?=@$bow[rinc]?></input>
<br>
<br>
...
?>
<td valign=middle>
 <input type=checkbox name=elogo id='elogo'>Поставить логотип </td><td><img width=35 height=42 align=absmiddle src=pfoto/e_logo.jpg />
 </td></tr>
