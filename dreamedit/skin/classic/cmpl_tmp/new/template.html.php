...
<script type="text/javascript" src="js/de_default.js?v=3"></script>
...
<body onload="setSize(<?=@$_TPL_REPLACMENT["LEFT_WIDTH"]?>); activateActionPanel(); loading();" onresize="setSize(leftGlobalForResize);">
...
<table width="100%">
	<tr valign="top">
		...
		<td height="100%">
			...
			<div class="left_block" id="left_block" onmouseover="setSize(700)" onmouseout="setSize(<?=@$_TPL_REPLACMENT["LEFT_WIDTH"]?>)">
				<!-- левый рабочий блок -->
		...
		<td>
			<h2><button id="toggleMenuButton" style="width: 150px; font-size: 10px;" onclick="toggleLeftMenu(this);">Свернуть меню</button> <?=@$_TPL_REPLACMENT["ACTION_TITLE"]?></h2>
