...
$query = "SELECT ac.el_id,ac.icont_text FROM adm_headers_element AS ae INNER JOIN adm_headers_content AS ac ON ac.el_id=ae.el_id WHERE ae.itype_id=".$conf_feetpost_director_block_id." AND ac.icont_var='sort' GROUP BY el_id ORDER BY ac.icont_text" or die("Error in the consult.." . mysqli_error($link)); 
