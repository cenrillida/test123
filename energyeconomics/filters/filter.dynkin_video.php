...
<div class="stage">
                    <div data-jcarouselautoscroll="true" data-jcarousel="true" class="carousel carousel-stage2">
                        <ul style="left: 0px; top: 0px;">
                        	...
                        	<li>
                        		<style>
                        		#play-button-piar-dynkin-video-".$i." {
								...
								#play-button-piar-dynkin-video-".$i.":hover {
								...
								echo "<a href=\"javascript:doPopup('//".$arr_video[$i]['youtube_url'].$params."', ".$par.")\"><div id=play-button-piar-dynkin-video-".$i.">
								</div></a>";
