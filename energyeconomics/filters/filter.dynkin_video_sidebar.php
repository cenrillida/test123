...
<div class="stage" style="width: 300">
                    <div data-jcarousel="true" class="carousel carousel-stage-ph-dynkin-sidebar">
                        <ul style="left: 0px; top: 0px;">
                            ...
                            <li>
                                <style>
                                #play-button-piar-dynkin-sidebar-".$i." {
                                ...
                                #play-button-piar-dynkin-sidebar-".$i.":hover {
                        		...
                        		echo "<a href=\"javascript:doPopup('//".$arr_video_sidebar_dynkin[$i]['youtube_url'].$params."', ".$par.")\"><div id=play-button-piar-dynkin-sidebar-".$i.">
                                </div></a>";
                    ...
                    <div data-jcarousel="true" class="carousel carousel-stage-ph-dynkin-sidebar1">
                        <ul style="left: 0px; top: 0px;">
                            <?php
                            for ($i=0; $i < $count_vg; $i++) { 
                    ...
                    <a data-jcarouselcontrol="true" href="#" class="prev prev-stage-ph-dynkin-sidebar inactive"><span>‹</span></a>
                    <a data-jcarouselcontrol="true" href="#" class="next next-stage-ph-dynkin-sidebar"><span>›</span></a>
 </div>
</div>
<?php
}?>