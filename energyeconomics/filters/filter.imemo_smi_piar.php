...
//echo "<div class='title red'>";
       echo $rows[date]."<br /><b style='font-size:16px;'><a target='_blank' href=/index.php?page_id=503&id=".$rows[id]."&ret=858>".$rows['title']."</a></b>";
//echo  "</div>";
...
if (!empty($rows[full_text]))
    echo "<a target='_blank' href=/index.php?page_id=503&id=".$rows[id]."&ret=858>подробнее...</a>";
}
?>
