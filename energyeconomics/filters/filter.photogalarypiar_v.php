...
<div class="stage" style="width: 300">
                    <div data-jcarousel="true" class="carousel carousel-stage-ph-v">
                        <ul style="left: 0px; top: 0px;">
                        	<?php
                        	for ($i=0; $i < $count_pg; $i++) { 
                        		echo '<li><table width=300><tr><td align="center"><img src="..'.$arr[$i]['photo_v'].'" alt="" height="300" width="200"></td></tr></table></li>';
                        	}
							?>
                        </ul>
                    </div>
                    
                    <div data-jcarousel="true" class="carousel carousel-stage-ph-v1">
                        <ul style="left: 0px; top: 0px;">
                        	<?php
                        	for ($i=0; $i < $count_pg; $i++) { 
                    ...
                    <a data-jcarouselcontrol="true" href="#" class="prev prev-stage-ph-v inactive"><span>‹</span></a>
                    <a data-jcarouselcontrol="true" href="#" class="next next-stage-ph-v"><span>›</span></a>
 </div>
</div>
<?php
}?>