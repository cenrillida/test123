...
(function () {
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        not: function (selector) {
            ...
            if (isSimple.test(selector)) return this.pushStack(jQuery.multiFilter(selector, this, true), "not", selector);
        ...
        add: function (selector) {
            ...
            this.get(), typeof selector === "string" ? jQuery(selector) : jQuery.makeArray(selector))));
        },
                ...
                if (typeof elem === "string") {
                    ...
                    if (!jQuery.support.tbody) {
                        ...
                        var hasBody = /<tbody/i.test(elem),
                            tbody = !tags.indexOf("<table") && !hasBody ? div.firstChild && div.firstChild.childNodes :
 ...
 */
    jQuery.event = {
        ...
        remove: function (elem, types, handler) {
            ...
            if (events) {
                ...
                if (types === undefined || (typeof types === "string" && types.charAt(0) == ".")) for (var type in events)
                this.remove(elem, type + (types || ""));
                    ...
                    jQuery.each(types.split(/\s+/), function (index, type) {
                        ...
                        if (events[type]) {
                            ...
                            else for (var handle in events[type])
    ...
    jQuery(window).bind('unload', function () {
        ...
        // Skip the window
        if (id != 1 && jQuery.cache[id].handle) jQuery.event.remove(jQuery.cache[id].handle.elem);
    });
    (function () {
...
/*
    ...
    jQuery.each(["Height", "Width"], function (i, name) {
        ...
        jQuery.fn[type] = function (size) {
            ...
            Math.max(
            document.documentElement["client" + name], document.body["scroll" + name], document.documentElement["scroll" + name], document.body["offset" + name], document.documentElement["offset" + name]) :
