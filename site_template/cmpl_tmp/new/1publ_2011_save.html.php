...
{
if(document.example_img.src==("https://www.imemo.ru/dreamedit/pfoto/"+a))
{
document.example_img.src="https://www.imemo.ru/dreamedit/pfoto/"+b;
}
else
{
document.example_img.src="https://www.imemo.ru/dreamedit/pfoto/"+a;
}
                                                ...
                                                <table cellspacing="0" cellpadding="0" border="0" align="center" class="pic_b">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <div class="pic_bl">
                                                            <div class="pic_br">
                                                            <div class="width_100"><a href="javascript:l_image ('.$result[0][picbig].' , '.$result[0][picmain].')"><img title="'.$result[0][name].'" src="/dreamedit/pfoto/'.$name_photo.'" name="example_img" border="0"   /></a></div>
                                                            </div>
                                                            </div>
                                                            </div>
                                                            </div>
