				...
				<div class="sep"> </div>
		<!--		<div id="commentspost">
					<h2 class="title">Нет комментариев</h2>
					<p>Вы можете быть первым кто оставить комментарий</p>
				</div>    -->
<?
...
<?			
				if ($_SESSION[lang]!='/en') 
				    echo "<h2><a rel='nofollow' href='#header'>Верх страницы</a></h2>";
				else	
				    echo "<h2><a rel='nofollow' href='#header'>Top</a></h2>";
?>
				</div>
			<!-- end .title -->
			<table width=100%><tr><td align=left>
			<?			
			if (!isset($_REQUEST[en])) echo $_TPL_REPLACMENT["COPYRIGHT"];
			else {
				if($_SESSION[jour_url]!="meimo")
					echo $_TPL_REPLACMENT["COPYRIGHT_EN"];
			}
