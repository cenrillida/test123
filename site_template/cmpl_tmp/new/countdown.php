    ...
    <div class="container-fluid countdowns">
        <div class="row justify-content-center">
            <div class="col-6 col-md-auto">
                ...
                <div class="text-center large-text-center"><?php if($_SESSION[lang]!="/en") echo 'Дней'; else echo 'Days';?></div>
            </div>
            <div class="col-6 col-md-auto">
                <div>
                    <div class="countdown_block">
                ...
                <div class="text-center large-text-center"><?php if($_SESSION[lang]!="/en") echo 'Часов'; else echo 'Hours';?></div>
            </div>
            <div class="col-6 col-md-auto">
                <div>
                    <div class="countdown_block">
                ...
                <div class="text-center large-text-center"><?php if($_SESSION[lang]!="/en") echo 'Минут'; else echo 'Minutes';?></div>
            </div>
            <div class="col-6 col-md-auto">
                <div>
                    <div class="countdown_block">
                ...
                <div class="text-center large-text-center"><?php if($_SESSION[lang]!="/en") echo 'Секунд'; else echo 'Seconds';?></div>
            </div>
        </div>
    </div>
