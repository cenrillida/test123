...
$elements[0][text]="<div class='mb-3' style='font-size: 17px;'>".$txt."</div>".$link_txt;
$elements[0][text_en]="<div class='mb-3' style='font-size: 17px;'>".$txt."</div>".$link_txt;
...
foreach($elements as $k => $v)
{
    ...
    $tpl->appendValues(array("TITLESIZE" => "4"));
