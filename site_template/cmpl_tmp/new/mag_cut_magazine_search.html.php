               ...
               foreach($art0 as $row)
			{
			   ...
			   foreach($art0 as $art)
			   {
			   	  ...
			   	  $nn=$mz0->getMagazineByArticleId($art[page_id]);
					   ...
					   if ($_SESSION[lang]!='/en') 
			      	   echo "<a href=".$_SESSION[lang]."/jour_cut/".$_SESSION[jour_url]."/index.php?page_id=".$jour[article_id]."&id=".$art[page_id]."&at=a&pid=".$people[id].">".$art[name].
			      	        " // ".$jour_name[0][page_name].". ".$num.$nn[0][page_name].". ".$nn[0][year].". ".$page.$art[pages];
					   else
					   		echo "<a href=".$_SESSION[lang]."/jour_cut/".$_SESSION[jour_url]."/index.php?page_id=".$jour[article_id]."&id=".$art[page_id]."&at=a&pid=".$people[id].">".$art[name_en].
