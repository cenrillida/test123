<?//Список мероприятий
global $DB;
$rows=$DB->select("SELECT c.el_id AS id,c.icont_text AS name,d.icont_text AS date,tt.icont_text AS type
       ...
       INNER JOIN adm_directories_content AS tt ON tt.el_id=v.icont_text AND tt.icont_var='text' 	   
