...
//echo $_TPL_REPLACMENT["TITLE_EN"];	
	...
	" WHERE p.page_id=".(int)$_REQUEST[page_id]);
	  ...
	  $pname=$DB->select("SELECT p.page_name,p.page_name_en,p.page_template,p.noright,p.notop,p.nobreadcrumbs,p.activatestat,p.noprint
	  FROM adm_pages AS p ".
...
<section class="pt-3 pb-5 bg-color-lightergray">
    <div class="container-fluid p-0 m-0">
        <div class="row printables-row p-0 m-0">
            <!-- left column -->
            <div class="<?php if($pname[0]['noright']=='1' || $_TPL_REPLACMENT['NO_RIGHT_COLUMN']=='1') echo 'col-xl-12'; else echo 'col-xl-9';?> col-xs-12 pt-3 pb-3 pr-xl-4 p-0 m-0">
                <div class="container-fluid left-column-container p-0 m-0">
                    <div class="row shadow border bg-white printables p-0 m-0">
                        <?php if($pname[0]['nobreadcrumbs']==0): ?>
                        <div class="col-12 pt-3 printable-none p-0 m-0 p-0 m-0">
                                        ...
                                        <div class="col-12 col-lg-4 mt-lg-auto order-last order-lg-1">
                                            ...
                                            if($pname[0]['notop']==0) {
                                                if ($_SESSION[lang] != "/en") {
                                                    ...
                                                    echo "<h3 class=\"pl-2 pr-2 text-center\">" . $title_seo . "</h3>";
                                                    ...
                                                    if ($title_seo != '') {
                                                        ...
                                                        echo "<h3 class=\"pl-2 pr-2 text-center\"'>" . $_TPL_REPLACMENT["TITLE"] . "</h3>";
                        ...
                        <div class="col-12 pt-3 pb-3 p-0 m-0">
                                    ...
                                    <div class="col-12 small">
                                        ...
                                        if($pname[0]['notop']==0) {
                                            if ($_SESSION[lang] != "/en") {
                                                ...
                                                echo "<h3 class=\"pl-2 pr-2 pb-2 text-center border-bottom\">" . $title_seo . "</h3>";
                        ...
                        <?php endif; ?>
                        <div class="col-12 pl-lg-5 pr-lg-5 pl-md-3 pr-md-3 pl-xs-2 pr-xs-2 pb-5 border-bottom text-content p-0 m-0">
                        <?php
                        if ($pname[0]['activatestat'] == 1) {
