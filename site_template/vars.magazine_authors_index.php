...
$tpl_vars = array(
	"label"     => array(
		"class"  => "base::header",
		"name" => "magazine_authors_index",
		"value" => "Журнал. Индекс авторов",
	),
	...
	"content_id"     => array(
		"class" => "base::integer",
		"prompt" => Dreamedit::translate("ID страницы Содержания номера"),
		"size" => "10",
		"field" => "content_id",
		"buttons" => "page_id",
       ),
	 "article_id"     => array(
       ...
       "persona_id"     => array(
		"class" => "base::integer",
		"prompt" => Dreamedit::translate("ID страницы Статьи автора"),
		"size" => "10",
		"field" => "persona_id",
		"buttons" => "page_id",
       ),
